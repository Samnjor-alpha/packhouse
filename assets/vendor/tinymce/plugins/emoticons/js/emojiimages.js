...
window.tinymce.Resource.add("tinymce.plugins.emoticons", {
  ...
  briefcase: {
    keywords: [ "business", "logbooksuploads", "work", "law", "legal", "job", "career" ],
  ...
  inbox_tray: {
    keywords: [ "email", "logbooksuploads" ],
  ...
  scroll: {
    keywords: [ "logbooksuploads", "ancient", "history", "paper" ],
  ...
  page_with_curl: {
    keywords: [ "logbooksuploads", "office", "paper" ],
  ...
  page_facing_up: {
    keywords: [ "logbooksuploads", "office", "paper", "information" ],
  ...
  clipboard: {
    keywords: [ "stationery", "logbooksuploads" ],
  ...
  file_folder: {
    keywords: [ "logbooksuploads", "business", "office" ],
  ...
  paperclip: {
    keywords: [ "logbooksuploads", "stationery" ],
  ...
  memo: {
    keywords: [ "write", "logbooksuploads", "stationery", "pencil", "paper", "writing", "legal", "exam", "quiz", "test", "study", "compose" ],
