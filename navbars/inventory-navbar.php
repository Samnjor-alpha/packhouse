<div class="card">
    <div class="card-body">
        ...
        <ul class="list-group">
            <li class="list-group-item <?php active('inventory.php') ?>"><i class="fas fa-seedling"></i><a href="inventory.php">
                    Raw Materials </a></li>

            <li class="list-group-item <?php active('addraw.php') ?>"><i class="fas fa-seedling"></i><a href="addraw.php">
